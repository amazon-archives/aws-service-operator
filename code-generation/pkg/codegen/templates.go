...
func awsServiceOperatorYamlTempl() (*asset, error) {
	...
	info := bindataFileInfo{name: "aws-service-operator.yaml.templ", size: 2657, mode: os.FileMode(436), modTime: time.Unix(1539666667, 0)}
...
func baseGoTempl() (*asset, error) {
	...
	info := bindataFileInfo{name: "base.go.templ", size: 784, mode: os.FileMode(420), modTime: time.Unix(1539668351, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func operatorGoTempl() (*asset, error) {
	...
	info := bindataFileInfo{name: "operator.go.templ", size: 11413, mode: os.FileMode(436), modTime: time.Unix(1539669055, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
