...
// GuarddutyV1alpha1Client is used to interact with features provided by the guardduty.awsoperator.io group.
...
func (c *GuarddutyV1alpha1Client) Masters(namespace string) MasterInterface {
