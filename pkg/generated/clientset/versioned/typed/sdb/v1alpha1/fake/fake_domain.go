...
type FakeDomains struct {
	Fake *FakeSdbV1alpha1
	ns   string
}

var domainsResource = schema.GroupVersionResource{Group: "sdb.awsoperator.io", Version: "v1alpha1", Resource: "domains"}

var domainsKind = schema.GroupVersionKind{Group: "sdb.awsoperator.io", Version: "v1alpha1", Kind: "Domain"}
