...
var virtualservicesResource = schema.GroupVersionResource{Group: "appmesh.awsoperator.io", Version: "v1alpha1", Resource: "virtualservices"}

var virtualservicesKind = schema.GroupVersionKind{Group: "appmesh.awsoperator.io", Version: "v1alpha1", Kind: "VirtualService"}
...
func (c *FakeVirtualServices) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.VirtualService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(virtualservicesResource, c.ns, name, pt, data, subresources...), &v1alpha1.VirtualService{})
