...
type PortfolioShareInterface interface {
	Create(*v1alpha1.PortfolioShare) (*v1alpha1.PortfolioShare, error)
	Update(*v1alpha1.PortfolioShare) (*v1alpha1.PortfolioShare, error)
	UpdateStatus(*v1alpha1.PortfolioShare) (*v1alpha1.PortfolioShare, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.PortfolioShare, error)
	List(opts v1.ListOptions) (*v1alpha1.PortfolioShareList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.PortfolioShare, err error)
...
func (c *portfolioShares) Get(name string, options v1.GetOptions) (result *v1alpha1.PortfolioShare, err error) {
...
func (c *portfolioShares) List(opts v1.ListOptions) (result *v1alpha1.PortfolioShareList, err error) {
...
func (c *portfolioShares) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *portfolioShares) Create(portfolioShare *v1alpha1.PortfolioShare) (result *v1alpha1.PortfolioShare, err error) {
	result = &v1alpha1.PortfolioShare{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("portfolioshares").
...
func (c *portfolioShares) Update(portfolioShare *v1alpha1.PortfolioShare) (result *v1alpha1.PortfolioShare, err error) {
	result = &v1alpha1.PortfolioShare{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("portfolioshares").
...
func (c *portfolioShares) UpdateStatus(portfolioShare *v1alpha1.PortfolioShare) (result *v1alpha1.PortfolioShare, err error) {
	result = &v1alpha1.PortfolioShare{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("portfolioshares").
...
func (c *portfolioShares) Delete(name string, options *v1.DeleteOptions) error {
...
func (c *portfolioShares) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
...
func (c *portfolioShares) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.PortfolioShare, err error) {
	result = &v1alpha1.PortfolioShare{}
