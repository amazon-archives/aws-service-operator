...
var rulesResource = schema.GroupVersionResource{Group: "events.awsoperator.io", Version: "v1alpha1", Resource: "rules"}

var rulesKind = schema.GroupVersionKind{Group: "events.awsoperator.io", Version: "v1alpha1", Kind: "Rule"}
...
func (c *FakeRules) UpdateStatus(rule *v1alpha1.Rule) (*v1alpha1.Rule, error) {
	obj, err := c.Fake.
