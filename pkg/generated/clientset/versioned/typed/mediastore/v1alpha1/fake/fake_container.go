...
type FakeContainers struct {
	Fake *FakeMediastoreV1alpha1
	ns   string
}

var containersResource = schema.GroupVersionResource{Group: "mediastore.awsoperator.io", Version: "v1alpha1", Resource: "containers"}

var containersKind = schema.GroupVersionKind{Group: "mediastore.awsoperator.io", Version: "v1alpha1", Kind: "Container"}
