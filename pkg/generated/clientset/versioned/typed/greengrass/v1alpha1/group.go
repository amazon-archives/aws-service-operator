...
type GroupInterface interface {
	...
	UpdateStatus(*v1alpha1.Group) (*v1alpha1.Group, error)
...
func newGroups(c *GreengrassV1alpha1Client, namespace string) *groups {
	return &groups{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *groups) UpdateStatus(group *v1alpha1.Group) (result *v1alpha1.Group, err error) {
	result = &v1alpha1.Group{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("groups").
