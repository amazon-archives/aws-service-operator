...
// CloudwatchV1alpha1Client is used to interact with features provided by the cloudwatch.awsoperator.io group.
type CloudwatchV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CloudwatchV1alpha1Client) Alarms(namespace string) AlarmInterface {
