...
// CloudtrailV1alpha1Client is used to interact with features provided by the cloudtrail.awsoperator.io group.
type CloudtrailV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CloudtrailV1alpha1Client) Trails(namespace string) TrailInterface {
