...
type FakeLoadBalancers struct {
	Fake *FakeElasticloadbalancingV1alpha1
	ns   string
}

var loadbalancersResource = schema.GroupVersionResource{Group: "elasticloadbalancing.awsoperator.io", Version: "v1alpha1", Resource: "loadbalancers"}

var loadbalancersKind = schema.GroupVersionKind{Group: "elasticloadbalancing.awsoperator.io", Version: "v1alpha1", Kind: "LoadBalancer"}
