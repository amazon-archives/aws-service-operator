...
var layerversionpermissionsResource = schema.GroupVersionResource{Group: "lambda.awsoperator.io", Version: "v1alpha1", Resource: "layerversionpermissions"}

var layerversionpermissionsKind = schema.GroupVersionKind{Group: "lambda.awsoperator.io", Version: "v1alpha1", Kind: "LayerVersionPermission"}
...
func (c *FakeLayerVersionPermissions) Get(name string, options v1.GetOptions) (result *v1alpha1.LayerVersionPermission, err error) {
	obj, err := c.Fake.
...
func (c *FakeLayerVersionPermissions) List(opts v1.ListOptions) (result *v1alpha1.LayerVersionPermissionList, err error) {
	obj, err := c.Fake.
...
func (c *FakeLayerVersionPermissions) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeLayerVersionPermissions) Create(layerVersionPermission *v1alpha1.LayerVersionPermission) (result *v1alpha1.LayerVersionPermission, err error) {
	obj, err := c.Fake.
...
func (c *FakeLayerVersionPermissions) Update(layerVersionPermission *v1alpha1.LayerVersionPermission) (result *v1alpha1.LayerVersionPermission, err error) {
	obj, err := c.Fake.
...
func (c *FakeLayerVersionPermissions) UpdateStatus(layerVersionPermission *v1alpha1.LayerVersionPermission) (*v1alpha1.LayerVersionPermission, error) {
	obj, err := c.Fake.
...
func (c *FakeLayerVersionPermissions) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeLayerVersionPermissions) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(layerversionpermissionsResource, c.ns, listOptions)
...
func (c *FakeLayerVersionPermissions) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.LayerVersionPermission, err error) {
	obj, err := c.Fake.
