...
// LambdaV1alpha1Client is used to interact with features provided by the lambda.awsoperator.io group.
...
func (c *LambdaV1alpha1Client) Versions(namespace string) VersionInterface {
