...
type CodepipelineV1alpha1Interface interface {
	...
	CustomActionTypesGetter
	PipelinesGetter
	WebhooksGetter
}

// CodepipelineV1alpha1Client is used to interact with features provided by the codepipeline.awsoperator.io group.
type CodepipelineV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CodepipelineV1alpha1Client) CustomActionTypes(namespace string) CustomActionTypeInterface {
	return newCustomActionTypes(c, namespace)
}

func (c *CodepipelineV1alpha1Client) Pipelines(namespace string) PipelineInterface {
