...
type IotV1alpha1Interface interface {
	...
	CertificatesGetter
	PoliciesGetter
	PolicyPrincipalAttachmentsGetter
	ThingsGetter
	ThingPrincipalAttachmentsGetter
	TopicRulesGetter
}

// IotV1alpha1Client is used to interact with features provided by the iot.awsoperator.io group.
...
func (c *IotV1alpha1Client) PolicyPrincipalAttachments(namespace string) PolicyPrincipalAttachmentInterface {
	return newPolicyPrincipalAttachments(c, namespace)
}
