...
var computeenvironmentsResource = schema.GroupVersionResource{Group: "batch.awsoperator.io", Version: "v1alpha1", Resource: "computeenvironments"}

var computeenvironmentsKind = schema.GroupVersionKind{Group: "batch.awsoperator.io", Version: "v1alpha1", Kind: "ComputeEnvironment"}
...
func (c *FakeComputeEnvironments) Get(name string, options v1.GetOptions) (result *v1alpha1.ComputeEnvironment, err error) {
	obj, err := c.Fake.
...
func (c *FakeComputeEnvironments) List(opts v1.ListOptions) (result *v1alpha1.ComputeEnvironmentList, err error) {
	obj, err := c.Fake.
...
func (c *FakeComputeEnvironments) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeComputeEnvironments) Create(computeEnvironment *v1alpha1.ComputeEnvironment) (result *v1alpha1.ComputeEnvironment, err error) {
	obj, err := c.Fake.
...
func (c *FakeComputeEnvironments) Update(computeEnvironment *v1alpha1.ComputeEnvironment) (result *v1alpha1.ComputeEnvironment, err error) {
	obj, err := c.Fake.
...
func (c *FakeComputeEnvironments) UpdateStatus(computeEnvironment *v1alpha1.ComputeEnvironment) (*v1alpha1.ComputeEnvironment, error) {
	obj, err := c.Fake.
...
func (c *FakeComputeEnvironments) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeComputeEnvironments) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(computeenvironmentsResource, c.ns, listOptions)
...
func (c *FakeComputeEnvironments) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ComputeEnvironment, err error) {
	obj, err := c.Fake.
