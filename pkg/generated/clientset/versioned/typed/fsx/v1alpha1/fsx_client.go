...
// FsxV1alpha1Client is used to interact with features provided by the fsx.awsoperator.io group.
type FsxV1alpha1Client struct {
	restClient rest.Interface
}

func (c *FsxV1alpha1Client) FileSystems(namespace string) FileSystemInterface {
