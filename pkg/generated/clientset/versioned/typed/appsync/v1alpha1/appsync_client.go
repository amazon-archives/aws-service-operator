...
type AppsyncV1alpha1Interface interface {
	...
	ApiKeysGetter
	DataSourcesGetter
	FunctionConfigurationsGetter
	GraphQLApisGetter
	GraphQLSchemasGetter
	ResolversGetter
}

// AppsyncV1alpha1Client is used to interact with features provided by the appsync.awsoperator.io group.
...
func (c *AppsyncV1alpha1Client) FunctionConfigurations(namespace string) FunctionConfigurationInterface {
	return newFunctionConfigurations(c, namespace)
}
...
func (c *AppsyncV1alpha1Client) GraphQLSchemas(namespace string) GraphQLSchemaInterface {
	return newGraphQLSchemas(c, namespace)
}
