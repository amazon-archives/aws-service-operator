...
var transitgatewayroutetablesResource = schema.GroupVersionResource{Group: "ec2.awsoperator.io", Version: "v1alpha1", Resource: "transitgatewayroutetables"}

var transitgatewayroutetablesKind = schema.GroupVersionKind{Group: "ec2.awsoperator.io", Version: "v1alpha1", Kind: "TransitGatewayRouteTable"}
...
func (c *FakeTransitGatewayRouteTables) Get(name string, options v1.GetOptions) (result *v1alpha1.TransitGatewayRouteTable, err error) {
	obj, err := c.Fake.
...
func (c *FakeTransitGatewayRouteTables) List(opts v1.ListOptions) (result *v1alpha1.TransitGatewayRouteTableList, err error) {
	obj, err := c.Fake.
...
func (c *FakeTransitGatewayRouteTables) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeTransitGatewayRouteTables) Create(transitGatewayRouteTable *v1alpha1.TransitGatewayRouteTable) (result *v1alpha1.TransitGatewayRouteTable, err error) {
	obj, err := c.Fake.
...
func (c *FakeTransitGatewayRouteTables) Update(transitGatewayRouteTable *v1alpha1.TransitGatewayRouteTable) (result *v1alpha1.TransitGatewayRouteTable, err error) {
	obj, err := c.Fake.
...
func (c *FakeTransitGatewayRouteTables) UpdateStatus(transitGatewayRouteTable *v1alpha1.TransitGatewayRouteTable) (*v1alpha1.TransitGatewayRouteTable, error) {
	obj, err := c.Fake.
...
func (c *FakeTransitGatewayRouteTables) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeTransitGatewayRouteTables) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(transitgatewayroutetablesResource, c.ns, listOptions)
...
func (c *FakeTransitGatewayRouteTables) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.TransitGatewayRouteTable, err error) {
	obj, err := c.Fake.
