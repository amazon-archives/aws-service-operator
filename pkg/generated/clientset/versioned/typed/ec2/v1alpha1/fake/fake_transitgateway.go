...
var transitgatewaysResource = schema.GroupVersionResource{Group: "ec2.awsoperator.io", Version: "v1alpha1", Resource: "transitgateways"}

var transitgatewaysKind = schema.GroupVersionKind{Group: "ec2.awsoperator.io", Version: "v1alpha1", Kind: "TransitGateway"}

// Get takes name of the transitGateway, and returns the corresponding transitGateway object, and an error if there is any.
func (c *FakeTransitGateways) Get(name string, options v1.GetOptions) (result *v1alpha1.TransitGateway, err error) {
	obj, err := c.Fake.
...
func (c *FakeTransitGateways) List(opts v1.ListOptions) (result *v1alpha1.TransitGatewayList, err error) {
	obj, err := c.Fake.
...
func (c *FakeTransitGateways) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeTransitGateways) Create(transitGateway *v1alpha1.TransitGateway) (result *v1alpha1.TransitGateway, err error) {
	obj, err := c.Fake.
...
func (c *FakeTransitGateways) Update(transitGateway *v1alpha1.TransitGateway) (result *v1alpha1.TransitGateway, err error) {
	obj, err := c.Fake.
...
func (c *FakeTransitGateways) UpdateStatus(transitGateway *v1alpha1.TransitGateway) (*v1alpha1.TransitGateway, error) {
	obj, err := c.Fake.
...
func (c *FakeTransitGateways) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeTransitGateways) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(transitgatewaysResource, c.ns, listOptions)
...
func (c *FakeTransitGateways) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.TransitGateway, err error) {
	obj, err := c.Fake.
