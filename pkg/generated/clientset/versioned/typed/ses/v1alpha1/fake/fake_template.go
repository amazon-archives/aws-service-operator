...
var templatesResource = schema.GroupVersionResource{Group: "ses.awsoperator.io", Version: "v1alpha1", Resource: "templates"}

var templatesKind = schema.GroupVersionKind{Group: "ses.awsoperator.io", Version: "v1alpha1", Kind: "Template"}
...
func (c *FakeTemplates) UpdateStatus(template *v1alpha1.Template) (*v1alpha1.Template, error) {
	obj, err := c.Fake.
