...
// SesV1alpha1Client is used to interact with features provided by the ses.awsoperator.io group.
...
func (c *SesV1alpha1Client) ConfigurationSetEventDestinations(namespace string) ConfigurationSetEventDestinationInterface {
