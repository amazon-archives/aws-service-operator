...
type LogsV1alpha1Interface interface {
	...
	LogStreamsGetter
	MetricFiltersGetter
	SubscriptionFiltersGetter
}

// LogsV1alpha1Client is used to interact with features provided by the logs.awsoperator.io group.
type LogsV1alpha1Client struct {
	restClient rest.Interface
}

func (c *LogsV1alpha1Client) Destinations(namespace string) DestinationInterface {
	return newDestinations(c, namespace)
}

func (c *LogsV1alpha1Client) LogGroups(namespace string) LogGroupInterface {
	return newLogGroups(c, namespace)
}

func (c *LogsV1alpha1Client) LogStreams(namespace string) LogStreamInterface {
	return newLogStreams(c, namespace)
}

func (c *LogsV1alpha1Client) MetricFilters(namespace string) MetricFilterInterface {
	return newMetricFilters(c, namespace)
}

func (c *LogsV1alpha1Client) SubscriptionFilters(namespace string) SubscriptionFilterInterface {
	return newSubscriptionFilters(c, namespace)
}
