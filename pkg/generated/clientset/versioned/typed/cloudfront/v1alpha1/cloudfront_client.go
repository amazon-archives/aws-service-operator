...
type CloudfrontV1alpha1Interface interface {
	...
	DistributionsGetter
	StreamingDistributionsGetter
}

// CloudfrontV1alpha1Client is used to interact with features provided by the cloudfront.awsoperator.io group.
type CloudfrontV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CloudfrontV1alpha1Client) CloudFrontOriginAccessIdentities(namespace string) CloudFrontOriginAccessIdentityInterface {
...
func (c *CloudfrontV1alpha1Client) StreamingDistributions(namespace string) StreamingDistributionInterface {
	return newStreamingDistributions(c, namespace)
}
