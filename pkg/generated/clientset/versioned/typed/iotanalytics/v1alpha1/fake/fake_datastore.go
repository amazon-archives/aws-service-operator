...
var datastoresResource = schema.GroupVersionResource{Group: "iotanalytics.awsoperator.io", Version: "v1alpha1", Resource: "datastores"}

var datastoresKind = schema.GroupVersionKind{Group: "iotanalytics.awsoperator.io", Version: "v1alpha1", Kind: "Datastore"}
...
func (c *FakeDatastores) List(opts v1.ListOptions) (result *v1alpha1.DatastoreList, err error) {
	...
	list := &v1alpha1.DatastoreList{ListMeta: obj.(*v1alpha1.DatastoreList).ListMeta}
...
func (c *FakeDatastores) UpdateStatus(datastore *v1alpha1.Datastore) (*v1alpha1.Datastore, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(datastoresResource, "status", c.ns, datastore), &v1alpha1.Datastore{})
...
func (c *FakeDatastores) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Datastore, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(datastoresResource, c.ns, name, pt, data, subresources...), &v1alpha1.Datastore{})
