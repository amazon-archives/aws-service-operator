...
type FakeServers struct {
	Fake *FakeOpsworkscmV1alpha1
	ns   string
}

var serversResource = schema.GroupVersionResource{Group: "opsworkscm.awsoperator.io", Version: "v1alpha1", Resource: "servers"}

var serversKind = schema.GroupVersionKind{Group: "opsworkscm.awsoperator.io", Version: "v1alpha1", Kind: "Server"}
