...
var tablesResource = schema.GroupVersionResource{Group: "dynamodb.awsoperator.io", Version: "v1alpha1", Resource: "tables"}

var tablesKind = schema.GroupVersionKind{Group: "dynamodb.awsoperator.io", Version: "v1alpha1", Kind: "Table"}

// Get takes name of the table, and returns the corresponding table object, and an error if there is any.
func (c *FakeTables) Get(name string, options v1.GetOptions) (result *v1alpha1.Table, err error) {
	obj, err := c.Fake.
...
func (c *FakeTables) List(opts v1.ListOptions) (result *v1alpha1.TableList, err error) {
	obj, err := c.Fake.
...
func (c *FakeTables) Create(table *v1alpha1.Table) (result *v1alpha1.Table, err error) {
	obj, err := c.Fake.
...
func (c *FakeTables) Update(table *v1alpha1.Table) (result *v1alpha1.Table, err error) {
	obj, err := c.Fake.
...
func (c *FakeTables) UpdateStatus(table *v1alpha1.Table) (*v1alpha1.Table, error) {
	obj, err := c.Fake.
...
func (c *FakeTables) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Table, err error) {
	obj, err := c.Fake.
