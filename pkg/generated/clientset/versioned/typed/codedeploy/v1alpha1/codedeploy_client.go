...
// CodedeployV1alpha1Client is used to interact with features provided by the codedeploy.awsoperator.io group.
type CodedeployV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CodedeployV1alpha1Client) Applications(namespace string) ApplicationInterface {
