...
var modelsResource = schema.GroupVersionResource{Group: "apigatewayv2.awsoperator.io", Version: "v1alpha1", Resource: "models"}

var modelsKind = schema.GroupVersionKind{Group: "apigatewayv2.awsoperator.io", Version: "v1alpha1", Kind: "Model"}
...
func (c *FakeModels) UpdateStatus(model *v1alpha1.Model) (*v1alpha1.Model, error) {
	obj, err := c.Fake.
