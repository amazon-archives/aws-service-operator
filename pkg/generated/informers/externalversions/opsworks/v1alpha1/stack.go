	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.OpsworksV1alpha1().Stacks(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OpsworksV1alpha1().Stacks(namespace).Watch(options)
			},
		},
		&opsworksv1alpha1.Stack{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *stackInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&opsworksv1alpha1.Stack{}, f.defaultInformer)
}
