...
import (
	...
	v1alpha1 "awsoperator.io/pkg/generated/listers/elasticsearch/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ElasticsearchV1alpha1().Domains(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ElasticsearchV1alpha1().Domains(namespace).Watch(options)
			},
		},
		&elasticsearchv1alpha1.Domain{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *domainInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&elasticsearchv1alpha1.Domain{}, f.defaultInformer)
}
