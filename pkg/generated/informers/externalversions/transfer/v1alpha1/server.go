	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TransferV1alpha1().Servers(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TransferV1alpha1().Servers(namespace).Watch(options)
			},
		},
		&transferv1alpha1.Server{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *serverInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&transferv1alpha1.Server{}, f.defaultInformer)
}
