	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.S3V1alpha1().Buckets(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.S3V1alpha1().Buckets(namespace).Watch(options)
			},
		},
		&s3v1alpha1.Bucket{},
		resyncPeriod,
...
func (f *bucketInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&s3v1alpha1.Bucket{}, f.defaultInformer)
}
