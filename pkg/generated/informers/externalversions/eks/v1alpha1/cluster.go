...
import (
	...
	v1alpha1 "awsoperator.io/pkg/generated/listers/eks/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EksV1alpha1().Clusters(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EksV1alpha1().Clusters(namespace).Watch(options)
			},
		},
		&eksv1alpha1.Cluster{},
		resyncPeriod,
...
func (f *clusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&eksv1alpha1.Cluster{}, f.defaultInformer)
}
