	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.WafV1alpha1().Rules(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.WafV1alpha1().Rules(namespace).Watch(options)
			},
		},
		&wafv1alpha1.Rule{},
		resyncPeriod,
...
func (f *ruleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&wafv1alpha1.Rule{}, f.defaultInformer)
}
