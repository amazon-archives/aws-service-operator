	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Elasticloadbalancingv2V1alpha1().LoadBalancers(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Elasticloadbalancingv2V1alpha1().LoadBalancers(namespace).Watch(options)
			},
		},
		&elasticloadbalancingv2v1alpha1.LoadBalancer{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *loadBalancerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&elasticloadbalancingv2v1alpha1.LoadBalancer{}, f.defaultInformer)
}
