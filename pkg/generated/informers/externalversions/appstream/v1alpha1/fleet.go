	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppstreamV1alpha1().Fleets(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppstreamV1alpha1().Fleets(namespace).Watch(options)
			},
		},
		&appstreamv1alpha1.Fleet{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fleetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appstreamv1alpha1.Fleet{}, f.defaultInformer)
}
