	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MqV1alpha1().Configurations(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MqV1alpha1().Configurations(namespace).Watch(options)
			},
		},
		&mqv1alpha1.Configuration{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *configurationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mqv1alpha1.Configuration{}, f.defaultInformer)
}
