	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RdsV1alpha1().DBClusterParameterGroups(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RdsV1alpha1().DBClusterParameterGroups(namespace).Watch(options)
			},
		},
		&rdsv1alpha1.DBClusterParameterGroup{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *dBClusterParameterGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&rdsv1alpha1.DBClusterParameterGroup{}, f.defaultInformer)
}
