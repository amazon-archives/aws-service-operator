	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Ec2V1alpha1().NetworkAcls(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Ec2V1alpha1().NetworkAcls(namespace).Watch(options)
			},
		},
		&ec2v1alpha1.NetworkAcl{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *networkAclInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&ec2v1alpha1.NetworkAcl{}, f.defaultInformer)
}
