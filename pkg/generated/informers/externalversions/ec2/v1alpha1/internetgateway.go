	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Ec2V1alpha1().InternetGateways(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Ec2V1alpha1().InternetGateways(namespace).Watch(options)
			},
		},
		&ec2v1alpha1.InternetGateway{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *internetGatewayInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&ec2v1alpha1.InternetGateway{}, f.defaultInformer)
}
