...
import (
	...
	v1alpha1 "awsoperator.io/pkg/generated/listers/codebuild/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CodebuildV1alpha1().Projects(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CodebuildV1alpha1().Projects(namespace).Watch(options)
			},
		},
		&codebuildv1alpha1.Project{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *projectInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&codebuildv1alpha1.Project{}, f.defaultInformer)
}
