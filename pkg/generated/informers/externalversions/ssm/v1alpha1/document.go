	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SsmV1alpha1().Documents(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SsmV1alpha1().Documents(namespace).Watch(options)
			},
		},
		&ssmv1alpha1.Document{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *documentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&ssmv1alpha1.Document{}, f.defaultInformer)
}
