	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsyncV1alpha1().ApiKeys(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsyncV1alpha1().ApiKeys(namespace).Watch(options)
			},
		},
		&appsyncv1alpha1.ApiKey{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *apiKeyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appsyncv1alpha1.ApiKey{}, f.defaultInformer)
}
