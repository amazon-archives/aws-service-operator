	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Apigatewayv2V1alpha1().Deployments(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Apigatewayv2V1alpha1().Deployments(namespace).Watch(options)
			},
		},
		&apigatewayv2v1alpha1.Deployment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *deploymentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apigatewayv2v1alpha1.Deployment{}, f.defaultInformer)
}
