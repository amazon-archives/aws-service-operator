	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Apigatewayv2V1alpha1().Models(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Apigatewayv2V1alpha1().Models(namespace).Watch(options)
			},
		},
		&apigatewayv2v1alpha1.Model{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *modelInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apigatewayv2v1alpha1.Model{}, f.defaultInformer)
}
