	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApigatewayV1alpha1().DomainNames(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApigatewayV1alpha1().DomainNames(namespace).Watch(options)
			},
		},
		&apigatewayv1alpha1.DomainName{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *domainNameInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apigatewayv1alpha1.DomainName{}, f.defaultInformer)
}
