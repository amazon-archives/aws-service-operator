	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GameliftV1alpha1().Aliases(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GameliftV1alpha1().Aliases(namespace).Watch(options)
			},
		},
		&gameliftv1alpha1.Alias{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *aliasInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&gameliftv1alpha1.Alias{}, f.defaultInformer)
}
