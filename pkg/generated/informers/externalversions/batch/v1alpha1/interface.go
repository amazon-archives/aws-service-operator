...
// ComputeEnvironments returns a ComputeEnvironmentInformer.
func (v *version) ComputeEnvironments() ComputeEnvironmentInformer {
	return &computeEnvironmentInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}

// JobDefinitions returns a JobDefinitionInformer.
func (v *version) JobDefinitions() JobDefinitionInformer {
	return &jobDefinitionInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
