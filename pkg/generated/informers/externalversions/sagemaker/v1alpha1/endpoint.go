	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SagemakerV1alpha1().Endpoints(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SagemakerV1alpha1().Endpoints(namespace).Watch(options)
			},
		},
		&sagemakerv1alpha1.Endpoint{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *endpointInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&sagemakerv1alpha1.Endpoint{}, f.defaultInformer)
}
