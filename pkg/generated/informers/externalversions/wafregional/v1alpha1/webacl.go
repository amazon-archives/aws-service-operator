	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.WafregionalV1alpha1().WebACLs(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.WafregionalV1alpha1().WebACLs(namespace).Watch(options)
			},
		},
		&wafregionalv1alpha1.WebACL{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *webACLInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&wafregionalv1alpha1.WebACL{}, f.defaultInformer)
}
