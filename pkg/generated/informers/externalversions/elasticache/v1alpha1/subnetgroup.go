	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ElasticacheV1alpha1().SubnetGroups(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ElasticacheV1alpha1().SubnetGroups(namespace).Watch(options)
			},
		},
		&elasticachev1alpha1.SubnetGroup{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *subnetGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&elasticachev1alpha1.SubnetGroup{}, f.defaultInformer)
}
