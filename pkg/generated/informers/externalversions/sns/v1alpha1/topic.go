	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SnsV1alpha1().Topics(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SnsV1alpha1().Topics(namespace).Watch(options)
			},
		},
		&snsv1alpha1.Topic{},
		resyncPeriod,
...
func (f *topicInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&snsv1alpha1.Topic{}, f.defaultInformer)
}
