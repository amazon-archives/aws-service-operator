...
import (
	...
	v1alpha1 "awsoperator.io/pkg/generated/listers/mediastore/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MediastoreV1alpha1().Containers(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MediastoreV1alpha1().Containers(namespace).Watch(options)
			},
		},
		&mediastorev1alpha1.Container{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *containerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mediastorev1alpha1.Container{}, f.defaultInformer)
}
