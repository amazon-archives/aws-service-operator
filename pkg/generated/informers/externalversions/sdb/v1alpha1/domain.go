...
import (
	...
	v1alpha1 "awsoperator.io/pkg/generated/listers/sdb/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SdbV1alpha1().Domains(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SdbV1alpha1().Domains(namespace).Watch(options)
			},
		},
		&sdbv1alpha1.Domain{},
		resyncPeriod,
...
func (f *domainInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&sdbv1alpha1.Domain{}, f.defaultInformer)
}
