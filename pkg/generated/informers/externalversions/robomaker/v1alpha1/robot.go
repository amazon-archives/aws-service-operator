	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RobomakerV1alpha1().Robots(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RobomakerV1alpha1().Robots(namespace).Watch(options)
			},
		},
		&robomakerv1alpha1.Robot{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *robotInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&robomakerv1alpha1.Robot{}, f.defaultInformer)
}
