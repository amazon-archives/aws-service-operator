...
// launchConfigurationLister implements the LaunchConfigurationLister interface.
...
func NewLaunchConfigurationLister(indexer cache.Indexer) LaunchConfigurationLister {
	return &launchConfigurationLister{indexer: indexer}
}

// List lists all LaunchConfigurations in the indexer.
func (s *launchConfigurationLister) List(selector labels.Selector) (ret []*v1alpha1.LaunchConfiguration, err error) {
...
func (s launchConfigurationNamespaceLister) Get(name string) (*v1alpha1.LaunchConfiguration, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("launchconfiguration"), name)
	}
	return obj.(*v1alpha1.LaunchConfiguration), nil
}
