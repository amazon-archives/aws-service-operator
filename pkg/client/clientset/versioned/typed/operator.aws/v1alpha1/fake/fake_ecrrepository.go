...
var ecrrepositoriesResource = schema.GroupVersionResource{Group: "operator.aws", Version: "v1alpha1", Resource: "ecrrepositories"}

var ecrrepositoriesKind = schema.GroupVersionKind{Group: "operator.aws", Version: "v1alpha1", Kind: "ECRRepository"}
