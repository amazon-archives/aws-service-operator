...
var sqsqueuesResource = schema.GroupVersionResource{Group: "operator.aws", Version: "v1alpha1", Resource: "sqsqueues"}

var sqsqueuesKind = schema.GroupVersionKind{Group: "operator.aws", Version: "v1alpha1", Kind: "SQSQueue"}
