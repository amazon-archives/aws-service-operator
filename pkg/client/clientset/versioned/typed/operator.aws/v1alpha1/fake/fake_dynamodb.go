...
var dynamodbsResource = schema.GroupVersionResource{Group: "operator.aws", Version: "v1alpha1", Resource: "dynamodbs"}

var dynamodbsKind = schema.GroupVersionKind{Group: "operator.aws", Version: "v1alpha1", Kind: "DynamoDB"}
