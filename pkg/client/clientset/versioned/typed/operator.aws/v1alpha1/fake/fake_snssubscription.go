...
var snssubscriptionsResource = schema.GroupVersionResource{Group: "operator.aws", Version: "v1alpha1", Resource: "snssubscriptions"}

var snssubscriptionsKind = schema.GroupVersionKind{Group: "operator.aws", Version: "v1alpha1", Kind: "SNSSubscription"}
