...
var snstopicsResource = schema.GroupVersionResource{Group: "serviceoperator.aws", Version: "v1alpha1", Resource: "snstopics"}

var snstopicsKind = schema.GroupVersionKind{Group: "serviceoperator.aws", Version: "v1alpha1", Kind: "SNSTopic"}
