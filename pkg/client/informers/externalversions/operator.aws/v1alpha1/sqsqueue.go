	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.OperatorV1alpha1().SQSQueues(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OperatorV1alpha1().SQSQueues(namespace).Watch(options)
			},
		},
		&operator_aws_v1alpha1.SQSQueue{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *sQSQueueInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&operator_aws_v1alpha1.SQSQueue{}, f.defaultInformer)
}
