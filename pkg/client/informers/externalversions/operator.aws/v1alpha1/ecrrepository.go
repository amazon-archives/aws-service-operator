	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.OperatorV1alpha1().ECRRepositories(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OperatorV1alpha1().ECRRepositories(namespace).Watch(options)
			},
		},
		&operator_aws_v1alpha1.ECRRepository{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *eCRRepositoryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&operator_aws_v1alpha1.ECRRepository{}, f.defaultInformer)
}
