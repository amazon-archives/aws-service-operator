	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.OperatorV1alpha1().SNSTopics(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OperatorV1alpha1().SNSTopics(namespace).Watch(options)
			},
		},
		&operator_aws_v1alpha1.SNSTopic{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *sNSTopicInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&operator_aws_v1alpha1.SNSTopic{}, f.defaultInformer)
}
