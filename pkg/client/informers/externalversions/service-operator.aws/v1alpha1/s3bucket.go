	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ServiceoperatorV1alpha1().S3Buckets(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ServiceoperatorV1alpha1().S3Buckets(namespace).Watch(options)
			},
		},
		&service_operator_aws_v1alpha1.S3Bucket{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *s3BucketInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&service_operator_aws_v1alpha1.S3Bucket{}, f.defaultInformer)
}
