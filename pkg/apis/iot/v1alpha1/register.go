...
// SchemeGroupVersion is group version used to register iot objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "iot." + awsoperator.GroupName,
...
// Adds the list of iot types to Scheme.
