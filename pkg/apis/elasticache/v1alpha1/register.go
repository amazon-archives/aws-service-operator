...
// SchemeGroupVersion is group version used to register elasticache objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "elasticache." + awsoperator.GroupName,
...
// Adds the list of elasticache types to Scheme.
