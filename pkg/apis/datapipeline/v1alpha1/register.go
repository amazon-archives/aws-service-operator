...
// SchemeGroupVersion is group version used to register datapipeline objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "datapipeline." + awsoperator.GroupName,
...
// Adds the list of datapipeline types to Scheme.
