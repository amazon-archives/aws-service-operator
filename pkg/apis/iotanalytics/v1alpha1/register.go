...
// SchemeGroupVersion is group version used to register iotanalytics objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "iotanalytics." + awsoperator.GroupName,
...
// Adds the list of iotanalytics types to Scheme.
