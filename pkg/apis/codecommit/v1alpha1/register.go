...
// SchemeGroupVersion is group version used to register codecommit objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "codecommit." + awsoperator.GroupName,
...
// Adds the list of codecommit types to Scheme.
