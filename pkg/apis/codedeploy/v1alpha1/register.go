...
// SchemeGroupVersion is group version used to register codedeploy objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "codedeploy." + awsoperator.GroupName,
...
// Adds the list of codedeploy types to Scheme.
