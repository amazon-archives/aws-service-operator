...
// SchemeGroupVersion is group version used to register cloudwatch objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "cloudwatch." + awsoperator.GroupName,
...
// Adds the list of cloudwatch types to Scheme.
