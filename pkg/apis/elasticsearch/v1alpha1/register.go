...
// SchemeGroupVersion is group version used to register elasticsearch objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "elasticsearch." + awsoperator.GroupName,
...
// Adds the list of elasticsearch types to Scheme.
