...
// SchemeGroupVersion is group version used to register apigateway objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "apigateway." + awsoperator.GroupName,
...
// Adds the list of apigateway types to Scheme.
