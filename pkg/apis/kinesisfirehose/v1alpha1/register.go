...
// SchemeGroupVersion is group version used to register kinesisfirehose objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "kinesisfirehose." + awsoperator.GroupName,
...
// Adds the list of kinesisfirehose types to Scheme.
