...
// SchemeGroupVersion is group version used to register redshift objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "redshift." + awsoperator.GroupName,
...
// Adds the list of redshift types to Scheme.
func addKnownTypes(scheme *runtime.Scheme) error {
	scheme.AddKnownTypes(SchemeGroupVersion,
		...
		&ClusterSecurityGroupIngressList{},
		&ClusterSubnetGroupList{},
	)
