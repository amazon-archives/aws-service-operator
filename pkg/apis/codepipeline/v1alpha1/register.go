...
// SchemeGroupVersion is group version used to register codepipeline objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "codepipeline." + awsoperator.GroupName,
...
// Adds the list of codepipeline types to Scheme.
