...
// SchemeGroupVersion is group version used to register cloudfront objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "cloudfront." + awsoperator.GroupName,
...
// Adds the list of cloudfront types to Scheme.
