...
// SchemeGroupVersion is group version used to register route53resolver objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "route53resolver." + awsoperator.GroupName,
...
// Adds the list of route53resolver types to Scheme.
