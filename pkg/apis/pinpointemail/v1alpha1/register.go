...
// SchemeGroupVersion is group version used to register pinpointemail objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "pinpointemail." + awsoperator.GroupName,
...
// Adds the list of pinpointemail types to Scheme.
