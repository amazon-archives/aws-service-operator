...
// SchemeGroupVersion is group version used to register autoscaling objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "autoscaling." + awsoperator.GroupName,
...
// Adds the list of autoscaling types to Scheme.
