...
// SchemeGroupVersion is group version used to register directoryservice objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "directoryservice." + awsoperator.GroupName,
...
// Adds the list of directoryservice types to Scheme.
