...
// SchemeGroupVersion is group version used to register appsync objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "appsync." + awsoperator.GroupName,
...
// Adds the list of appsync types to Scheme.
