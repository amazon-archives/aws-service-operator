...
// SchemeGroupVersion is group version used to register wafregional objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "wafregional." + awsoperator.GroupName,
...
// Adds the list of wafregional types to Scheme.
