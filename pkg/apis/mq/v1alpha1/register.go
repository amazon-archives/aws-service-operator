...
// SchemeGroupVersion is group version used to register mq objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "mq." + awsoperator.GroupName,
...
// Adds the list of mq types to Scheme.
