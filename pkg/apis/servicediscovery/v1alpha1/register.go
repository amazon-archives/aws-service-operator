...
// SchemeGroupVersion is group version used to register servicediscovery objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "servicediscovery." + awsoperator.GroupName,
...
// Adds the list of servicediscovery types to Scheme.
