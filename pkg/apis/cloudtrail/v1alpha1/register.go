...
// SchemeGroupVersion is group version used to register cloudtrail objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "cloudtrail." + awsoperator.GroupName,
...
// Adds the list of cloudtrail types to Scheme.
