...
// SchemeGroupVersion is group version used to register autoscalingplans objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "autoscalingplans." + awsoperator.GroupName,
...
// Adds the list of autoscalingplans types to Scheme.
