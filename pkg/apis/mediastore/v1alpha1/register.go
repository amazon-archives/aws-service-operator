...
// SchemeGroupVersion is group version used to register mediastore objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "mediastore." + awsoperator.GroupName,
...
// Adds the list of mediastore types to Scheme.
