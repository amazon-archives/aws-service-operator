...
// SchemeGroupVersion is group version used to register stepfunctions objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "stepfunctions." + awsoperator.GroupName,
...
// Adds the list of stepfunctions types to Scheme.
