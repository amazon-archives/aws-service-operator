...
// SchemeGroupVersion is group version used to register elasticbeanstalk objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "elasticbeanstalk." + awsoperator.GroupName,
...
// Adds the list of elasticbeanstalk types to Scheme.
