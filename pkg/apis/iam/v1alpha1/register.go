...
// SchemeGroupVersion is group version used to register iam objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "iam." + awsoperator.GroupName,
...
// Adds the list of iam types to Scheme.
