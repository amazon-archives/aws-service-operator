...
// SchemeGroupVersion is group version used to register workspaces objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "workspaces." + awsoperator.GroupName,
...
// Adds the list of workspaces types to Scheme.
