...
// SchemeGroupVersion is group version used to register opsworkscm objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "opsworkscm." + awsoperator.GroupName,
...
// Adds the list of opsworkscm types to Scheme.
