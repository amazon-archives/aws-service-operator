...
func (c *Controller) syncAdditionalResources(s *awsV1alpha1.S3Bucket) (err error) {
...
func createService(config *config.Config, s *awsV1alpha1.S3Bucket, svcType string, externalName string) string {
	logger := config.Logger
