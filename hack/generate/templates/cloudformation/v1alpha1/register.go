...
// SchemeGroupVersion is group version used to register cloudformation objects
var SchemeGroupVersion = schema.GroupVersion{
	Group:   "cloudformation." + awsoperator.GroupName,
...
// Adds the list of cloudformation types to Scheme.
